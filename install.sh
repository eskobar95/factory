...
echo "Next steps:"
echo "  Planning track:"
echo "    /align → /to-prd → /to-backlog   (recommended)"
echo "    /to-plan                         (all-in-one, was /po-breakdown)"
echo "  Harness track:"
echo "    Create branch 'dev' → /run-sprint S001 → /milestone-review M001"
echo "  Optional: npx skills add mattpocock/skills — see skills/catalog/README.md"
echo ""
