...
<!-- Fill in: what does this app do, who are the users, what data is sensitive -->
- App type: [e.g. multi-tenant SaaS / internal tool / public API]
- Sensitive data: [e.g. payment data, PII, tenant isolation]
- Auth provider: [e.g. Clerk, NextAuth, custom JWT]
